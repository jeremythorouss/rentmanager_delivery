                        ...
                        <form class="form-horizontal" method="post" >
                            <div class="box-body">                        
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="constructeur" name="constructeur" value="${constructeur}" required>
                                ...
                                <div class="form-group">
                                    <label for="nb_places" class="col-sm-2 control-label">nb_places</label>

                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="nb_places" name="nb_places" value="${nb_places}" required >
